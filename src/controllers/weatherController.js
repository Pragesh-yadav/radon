...
let getWeather = async function(req,res){
    try {
        ...
        const options = {
            "method" : "get",
            "url" : `http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=ad2e2b6dbb6cf179ff62168974814466`
        }
...
const sortByTemp = async function(req,res){
    try {
        ...
        for(let i=0; i < cities.length; i++){
            const options = {
                "method" : "get",
                "url" : `http://api.openweathermap.org/data/2.5/weather?q=${cities[i]}&appid=ad2e2b6dbb6cf179ff62168974814466`
            }
